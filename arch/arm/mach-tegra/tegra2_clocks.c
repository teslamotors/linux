...
static void tegra2_plle_clk_disable(struct clk *c)
{
	u32 val;
	pr_debug("%s on clock %s\n", __func__, c->name);
...
#define TEGRA_PLLE_TIMEOUT 300
static int tegra2_plle_clk_enable(struct clk *c)
{

	u32 val;
	int timeout = TEGRA_PLLE_TIMEOUT;
	pr_debug("%s on clock %s\n", __func__, c->name);

	tegra2_plle_clk_disable(c);

	val = pmc_readl(PMC_SCRATCH42);
	if (val & PMC_SCRATCH42_PCX_CLAMP)
		return -EBUSY;

	val |= PMC_SCRATCH42_PCX_CLAMP;
	pmc_writel(val, PMC_SCRATCH42);
	udelay(1);
	val &= ~PMC_SCRATCH42_PCX_CLAMP;
	pmc_writel(val, PMC_SCRATCH42);
	...
	do {
		...
		udelay(1);
		timeout--;
	} while (!(val & PLLE_MISC_READY) && timeout);

	if (!timeout) {
		pr_err("%s: TIMEOUT: unable enable PLLE.\n", __func__);
		return -EBUSY;
	}
...
static struct clk_ops tegra_plle_ops = {
	...
	.disable    = tegra2_plle_clk_disable,
};
...
/*	  input	    output    n    m   p  cpcon	*/
	{ 12000000, 25175000, 200, 12, 2, 8},
	{ 13000000, 25175000, 200, 13, 2, 8},
	{ 12000000, 28320000, 226, 12, 2, 8},
	{ 13000000, 28320000, 226, 13, 2, 8},
	{ 12000000, 31500000, 252, 12, 2, 8},
	{ 13000000, 31500000, 252, 13, 2, 8},
	{ 12000000, 36000000, 288, 12, 2, 8},
	{ 13000000, 36000000, 288, 13, 2, 8},
	{ 12000000, 40000000, 320, 12, 2, 8},
	{ 13000000, 40000000, 320, 13, 2, 8},
	{ 12000000, 49500000, 396, 12, 2, 8},
	{ 13000000, 49500000, 396, 13, 2, 8},
	{ 12000000, 50000000, 200, 12, 2, 8},
	{ 13000000, 50000000, 200, 13, 2, 8},
	{ 12000000, 56250000, 225, 12, 2, 8},
	{ 13000000, 56250000, 225, 13, 2, 8},
	{ 12000000, 65000000, 260, 12, 2, 8},
	{ 13000000, 65000000, 260, 13, 2, 8},
	{ 12000000, 75000000, 300, 12, 2, 8},
	{ 13000000, 75000000, 300, 13, 2, 8},
	{ 12000000, 78750000, 315, 12, 2, 8},
	{ 13000000, 78750000, 315, 13, 2, 8},
	{ 12000000, 85500000, 342, 12, 2, 8},
	{ 13000000, 85500000, 342, 13, 2, 8},
	{ 12000000, 94500000, 378, 12, 2, 8},
	{ 13000000, 94500000, 378, 13, 2, 8},
	{ 12000000, 106500000, 213, 12, 2, 8},
	{ 13000000, 106500000, 213, 13, 2, 8},
	{ 12000000, 108000000, 216, 12, 2, 8},
	{ 13000000, 108000000, 216, 13, 2, 8},
	{ 12000000, 135000000, 270, 12, 2, 8},
	{ 13000000, 135000000, 270, 13, 2, 8},
	{ 12000000, 146250000, 292, 12, 2, 8},
	{ 13000000, 146250000, 292, 13, 2, 8},
	{ 12000000, 162000000, 324, 12, 2, 8},
	{ 13000000, 162000000, 324, 13, 2, 8},
	{ 13000000, 216000000, 432, 13, 2, 8},
	{ 12000000, 297000000, 297, 12, 1, 8},
	{ 13000000, 297000000, 297, 13, 1, 8},
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("spdif_out",	"spdif",		NULL,	10,	0x108,	100000000, mux_pllaout0_audio2x_pllp_clkm,	MUX | DIV_U71),
	PERIPH_CLK("spdif_in",	"spdif",		NULL,	10,	0x10c,	100000000, mux_pllp_pllc_pllm,		MUX | DIV_U71),
	PERIPH_CLK("pwm",	"pwm",			NULL,	17,	0x110,	432000000, mux_pllp_pllc_audio_clkm_clk32,	MUX | DIV_U71),
	PERIPH_CLK("spi",	"spi",			NULL,	43,	0x114,	40000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("xio",	"xio",			NULL,	45,	0x120,	150000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("twc",	"twc",			NULL,	16,	0x12c,	150000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("sbc1",	"spi_tegra.0",		NULL,	41,	0x134,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("sbc2",	"spi_tegra.1",		NULL,	44,	0x118,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("sbc3",	"spi_tegra.2",		NULL,	46,	0x11c,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("sbc4",	"spi_tegra.3",		NULL,	68,	0x1b4,	240000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	...
	PERIPH_CLK("pcie",	"tegra-pcie",		"pcie",	70,	0,	10000000,	mux_clk_m,	0),
	PERIPH_CLK("afi",	"tegra-pcie",		"afi",	72,	0,	10000000,	mux_clk_m,	0),
	PERIPH_CLK("pciex",	"tegra-pcie",		"pciex",	74,	0,	10000000,	mux_clk_m,	0),
/* FIXME: what is la? */
	PERIPH_CLK("la",	"la",			NULL,	76,	0x1f8,	26000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("owr",	"tegra_w1",		NULL,	71,	0x1cc,	26000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71),
	PERIPH_CLK("nor",	"tegra_nor",		NULL,	42,	0x1d0,	92000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), /* requires min voltage */
	...
	PERIPH_CLK("uarta",	"uart.0",		NULL,	6,	0x178,	666000000, mux_pllp_pllc_pllm_clkm,	MUX),
	PERIPH_CLK("uartb",	"uart.1",		NULL,	7,	0x17c,	666000000, mux_pllp_pllc_pllm_clkm,	MUX),
	PERIPH_CLK("uartc",	"uart.2",		NULL,	55,	0x1a0,	666000000, mux_pllp_pllc_pllm_clkm,	MUX),
	PERIPH_CLK("uartd",	"uart.3",		NULL,	65,	0x1c0,	666000000, mux_pllp_pllc_pllm_clkm,	MUX),
	...
	PERIPH_CLK("host1x",	"host1x",		NULL,	28,	0x180,	280000000, mux_pllm_pllc_pllp_plla,	MUX | DIV_U71), /* scales with voltage and process_id */
...
struct clk_duplicate tegra_clk_duplicates[] = {
	...
	CLK_DUPLICATE("sbc2", "tegra_spi_slave.1", NULL),
	CLK_DUPLICATE("sbc3", "tegra_spi_slave.2", NULL),
	CLK_DUPLICATE("sbc4", "tegra_spi_slave.3", NULL),
	CLK_DUPLICATE("i2s1",	"tdm.0", NULL),
	CLK_DUPLICATE("i2s2",	"tdm.1", NULL),
	CLK_DUPLICATE("vi",	"tegra_itu656", "vi"),
	CLK_DUPLICATE("csus",	"tegra_itu656", "csus"),
};
...
static void __init tegra2_enable_pllp(void)
{
	clk_writel( 0x5011b00c, CLK_RESET_PLLP_BASE);
	clk_writel( 0x10031c03, CLK_RESET_PLLP_OUTA);
	clk_writel( 0x06030a03, CLK_RESET_PLLP_OUTB);
	clk_writel( 0x00000800, CLK_RESET_PLLP_MISC);
