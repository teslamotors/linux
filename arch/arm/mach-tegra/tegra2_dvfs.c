...
static struct dvfs dvfs_init_tab1[] = {
	...
	/* Core voltages (mV):       950,    1000,   1100,   1200,   1250    1275 */
	 ...
	 */
	CORE_DVFS("sdmmc1",  1, KHZ, 44000,  52000,  52000,  52000,  52000, 52000),
	CORE_DVFS("sdmmc2",  1, KHZ, 44000,  52000,  52000,  52000,  52000, 52000),
	CORE_DVFS("sdmmc3",  1, KHZ, 44000,  52000,  52000,  52000,  52000, 52000),
	CORE_DVFS("sdmmc4",  1, KHZ, 44000,  52000,  52000,  52000,  52000, 52000),
#endif
	...
	CORE_DVFS("mipi",    1, KHZ, 0,      40000,  40000,  40000,  40000,  60000),
	CORE_DVFS("usbd",    1, KHZ, 0,      0,      480000, 480000, 480000, 480000),
	CORE_DVFS("usb2",    1, KHZ, 0,      0,      480000, 480000, 480000, 480000),
	CORE_DVFS("usb3",    1, KHZ, 0,      0,      480000, 480000, 480000, 480000),
...
static struct dvfs dvfs_init_tab2[] = {
        ...
        CORE_DVFS("emc",     1, KHZ,       0,       0,      0,      0,      0, 666000, 666000, 666000),
        ...
        /* Core voltages (mV):            950,    1000,   1100,   1200,   1225, 1250,    1275,   1300 */
        CORE_DVFS("ndflash",  1, KHZ,      0,      0,      0,      0,      0,  86500,   86500,   86500),
        CORE_DVFS("nor",      1, KHZ,      0,      0,      0,      0,      0,  86500,   86500,   86500),
        CORE_DVFS("ide",      1, KHZ,      0,      0,      0,      0,      0, 100000,  100000,  100000),
        CORE_DVFS("mipi",     1, KHZ,      0,      0,      0,      0,      0,  40000,   40000,   40000),
        CORE_DVFS("usbd",     1, KHZ,      0,      0,      0,      0,      0, 480000,  480000,  480000),
        CORE_DVFS("usb2",     1, KHZ,      0,      0,      0,      0,      0, 480000,  480000,  480000),
        CORE_DVFS("usb3",     1, KHZ,      0,      0,      0,      0,      0, 480000,  480000,  480000),
        CORE_DVFS("pcie",     1, KHZ,      0,      0,      0,      0,      0, 250000,  250000,  250000),
        CORE_DVFS("dsi",      1, KHZ,      0,      0,      0,      0,      0, 500000,  500000,  500000),
        CORE_DVFS("tvo",      1, KHZ,      0,      0,      0,      0,      0, 250000,  250000,  250000),
	...
	/*
         ...
         * and let the display driver call tegra_dvfs_set_rate manually
         */
        CORE_DVFS("disp1",    0, KHZ,      0,      0,      0,      0,      0, 190000,  190000,  190000),
        CORE_DVFS("disp2",    0, KHZ,      0,      0,      0,      0,      0, 190000,  190000,  190000),
        CORE_DVFS("hdmi",     0, KHZ,      0,      0,      0,      0,      0, 148500,  148500,  148500),
         ...
         */
        CORE_DVFS("host1x",   1, KHZ,      0,      0,      0,      0,      0, 280000,  280000,  280000),
        CORE_DVFS("epp",      1, KHZ,      0,      0,      0,      0,      0, 300000,  300000,  300000),
        CORE_DVFS("2d",       1, KHZ,      0,      0,      0,      0,      0, 300000,  300000,  300000),
        CORE_DVFS("3d",       1, KHZ,      0,      0,      0,      0,      0, 300000,  300000,  300000),
        CORE_DVFS("mpe",      1, KHZ,      0,      0,      0,      0,      0, 300000,  300000,  300000),
        CORE_DVFS("vi",       1, KHZ,      0,      0,      0,      0,      0, 150000,  150000,  150000),
        CORE_DVFS("sclk",     1, KHZ,      0,      0,      0,      0,      0, 240000,  240000,  240000),
        CORE_DVFS("vde",      1, KHZ,      0,      0,      0,      0,      0, 300000,  300000,  300000),
        /* What is this? */
        CORE_DVFS("NVRM_DEVID_CLK_SRC", 1, MHZ,   0,   0,   0,   0,   0, 1067, 1067, 1067),
};
...
void __init tegra2_init_dvfs(void)
{
	...
	BUG_ON(speedo_id >= ARRAY_SIZE(dvfs_tables));
	BUG_ON(speedo_id >= ARRAY_SIZE(dvfs_table_sizes));
