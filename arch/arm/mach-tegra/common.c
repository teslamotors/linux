...
static __initdata struct tegra_clk_init_table common_clk_init_table[] = {
	...
	{ "pll_m_out1",	"pll_m",	133200000,	true },
	{ "sclk",	"pll_m_out1",	133200000,	true },
	{ "hclk",	"sclk",		133200000,	true },
	{ "pclk",	"hclk",		66600000,	true },
	{ "pll_x",	NULL,		0,		true },
	{ "cpu",	NULL,		0,		true },
	{ "emc",	NULL,		0,		true },
	{ "csite",	NULL,		0,		true },
...
static void tegra_chip_serial_number(void)
{
	unsigned long long chip_uid = tegra_chip_uid();

	system_serial_low = (unsigned int) chip_uid;
	system_serial_high = (unsigned int) (chip_uid >> 32ull);
}
...
void __init tegra_common_init(void)
{
	...
	tegra_init_apb_dma();
	/*
	 * To be called before tegra_chip_serial_number
	 * which overrides system_serial_{low,high}
	 */
	board_serial_proc();
	tegra_chip_serial_number();
}
