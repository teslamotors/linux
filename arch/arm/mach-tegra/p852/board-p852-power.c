...
static void __init tps6586x_rtc_preinit(void)
{
	...
	if (machine_is_p852_sku23_b00() ||
		machine_is_p852_sku23_c01() ||
		machine_is_p852_sku13_b00() ||
		machine_is_p852_sku5_b00()  ||
		machine_is_p852_sku5_c01() ) {
		for (i = 0; i < tps_platform.num_subdevs; ++i)
			if (!strcmp(tps_platform.subdevs[i].name,"tps6586x-rtc"))
				rtc_pdata =
				(struct tps6586x_rtc_platform_data *) (tps_platform.subdevs[i].platform_data);
				rtc_pdata->xtal_load_capacitance = RTC_CL_SEL_1P5;
	}
}
