...
static unsigned get_saved_tgid(int idx)
{
	return savedcmd->saved_tgids[idx];
}

static void set_saved_tgid(int idx, unsigned tgid)
{
	savedcmd->saved_tgids[idx] = tgid;
}
