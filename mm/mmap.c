			...
			unsigned long *populate)
{
	...
	*populate = 0;
	...
	/*
	 * Set VM_STACK_FLAGS for the thread stack mapping to avoid
	 * vma merging with other anonymous vma's. Identify the thread
	 * stack mapping using MAP_STACK that is set by glibc's thread
	 * implementation.
	 */
	if (flags & MAP_STACK)
