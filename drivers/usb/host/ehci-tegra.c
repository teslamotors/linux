...
static int tegra_ehci_probe(struct platform_device *pdev)
{
	...
	/*setting TXFILLTUNING register and AHB-Prefetch registers to avoid TX FIFO underrun
	and subsequent Ethernet lockup in Tegra 2*/

	printk("setting TXFILLTUNING registers\n");
	...
	if (pdev->id == 2) {
		printk("setting AHB-prefetch registers for USB3\n");
