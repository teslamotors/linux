...
static struct mtd_partition infoz_flash_parts0[] = {
	...
	{ .name = "RSVD0",		.size = 704*KB,		.offset = MTDPART_OFS_NXTBLK, },
...
static struct mtd_partition infoz_flash_parts1[] = {
	...
	/* Includes FMAP in last 2 KB */
	{ .name = "ALT_RSVD0",		.size = 704*KB,		.offset = MTDPART_OFS_NXTBLK, },
	...
	{ .name = "UPDATE_HOLE",	.size = 192*KB,		.offset = 0x720000, },
	{ .name = "UPDATE_1",		.size = 25280*KB,	.offset = 0x750000, },
};
