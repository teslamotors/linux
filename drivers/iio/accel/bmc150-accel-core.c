...
static struct attribute *bmc150_accel_fifo_attributes[] = {
...
static const struct attribute_group bmc150_accel_fifo_attrgroup = {
        .attrs = bmc150_accel_fifo_attributes,
};
			    ...
			    const char *name, bool block_supported)
{
	...
	if (data->irq > 0) {
		...
		if (block_supported) {
			...
			indio_dev->buffer->attrs = &bmc150_accel_fifo_attrgroup;
		}
	}
