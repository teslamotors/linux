 ...
 *
 * $Id: dhd_linux.c 702846 2018-09-04 11:39:39Z $
 */
...
#ifndef CONFIG_DHD_SET_RANDOM_MAC_VAL_TESLA
#define CONFIG_DHD_SET_RANDOM_MAC_VAL_TESLA	0x001A11
#endif
static u32 vendor_oui = CONFIG_DHD_SET_RANDOM_MAC_VAL_TESLA;
...
bool dhd_update_fw_nv_path(dhd_info_t *dhdinfo)
{
	...
	if (!dhd_download_fw_on_driverload) {
#ifdef CONFIG_BCMDHD_FW_PATH_TESLA
		fw = CONFIG_BCMDHD_FW_PATH_TESLA;
#endif /* CONFIG_BCMDHD_FW_PATH_TESLA */
#ifdef CONFIG_BCMDHD_NVRAM_PATH_TESLA
		nv = CONFIG_BCMDHD_NVRAM_PATH_TESLA;
#endif /* CONFIG_BCMDHD_NVRAM_PATH_TESLA */
	}
...
dhd_free(dhd_pub_t *dhdp)
{
	...
	if (dhdp) {
		...
		dhd = (dhd_info_t *)dhdp->info;
		if (dhdp->soc_ram) {
#if defined(CONFIG_DHD_USE_STATIC_BUF_TESLA) && defined(DHD_USE_STATIC_MEMDUMP)
			DHD_OS_PREFREE(dhdp, dhdp->soc_ram, dhdp->soc_ram_length);
#else
			MFREE(dhdp->osh, dhdp->soc_ram, dhdp->soc_ram_length);
#endif /* CONFIG_DHD_USE_STATIC_BUF_TESLA && DHD_USE_STATIC_MEMDUMP */
			dhdp->soc_ram = NULL;
		}
