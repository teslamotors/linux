...
#define TRAV_PIN_BANK_EINTN(pins, reg, id)		\
	{						\
		.type		= &trav_bank_type_off,	\
		.pctl_offset	= reg,			\
		.nr_pins	= pins,			\
		.eint_type	= EINT_TYPE_NONE,	\
		.name		= id			\
...
#define TRAV_PIN_BANK_EINTG(pins, reg, id, offs)	\
	{						\
		.type		= &trav_bank_type_off,	\
		.pctl_offset	= reg,			\
		.nr_pins	= pins,			\
...
#define TRAV_PIN_BANK_EINTW(pins, reg, id, offs)	\
	{						\
		.type		= &trav_bank_type_alive,\
		.pctl_offset	= reg,			\
		.nr_pins	= pins,			\
		.eint_type	= EINT_TYPE_WKUP,	\
		.eint_offset	= offs,			\
