...
struct s5p_mfc_regs {
	...
	void __iomem *d_luma_crc;
	void __iomem *d_chroma_crc;
	void __iomem *d_picture_profile; /* v12 */
	void __iomem *d_first_plane_2bit_dbp_stride_size; /* v12 */
	void __iomem *d_first_plane_2bit_dbp_size; /* v12 */
	...
	void __iomem *e_vp9_options; /* v11 */
	void __iomem *e_vp9_golden_frame_option; /* v11 */
	void __iomem *e_first_plane_2bit_stride_size; /* v12 */
	void __iomem *e_first_plane_2bit_size; /* v12 */
};
...
struct s5p_mfc_hw_ops {
	...
	int (*get_picture_profile)(struct s5p_mfc_dev *dev);
	int (*get_luma_bit_depth_minus8)(struct s5p_mfc_dev *dev);
	int (*get_chroma_bit_depth_minus8)(struct s5p_mfc_dev *dev);
	int (*get_hevc_422)(struct s5p_mfc_dev *dev);
