...
static int ipu_platform_probe(struct platform_device *pdev)
{
...
static int ipu_platform_remove(struct platform_device *pdev)
{
...
static struct platform_driver stub_platform_driver = {
	...
	.probe = ipu_platform_probe,
	.remove = ipu_platform_remove,
