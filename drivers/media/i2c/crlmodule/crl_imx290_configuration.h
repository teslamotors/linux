...
static struct crl_register_write_rep imx290_1948_1097_37MHZ_CROPPING[] = {
...
static struct crl_arithmetic_ops imx290_shs_msb_ops[] = {
	{
...
static struct crl_arithmetic_ops imx290_shs_hsb_ops[] = {
	{
		.op = CRL_BITWISE_RSHIFT,
...
static struct crl_dynamic_register_access imx290_shs_regs[] = {
	{
		.address = 0x3020,
		.len = CRL_REG_LEN_08BIT,
		.ops_items = 0,
	...
	},
	{
		.address = 0x3021,
		.len = CRL_REG_LEN_08BIT,
		.ops_items = ARRAY_SIZE(imx290_shs_msb_ops),
		.ops = imx290_shs_msb_ops,
		.mask = 0xff,
	...
	},
	{
		.address = 0x3022,
		.len = CRL_REG_LEN_08BIT,
		.ops_items = ARRAY_SIZE(imx290_shs_hsb_ops),
		.ops = imx290_shs_hsb_ops,
		.mask = 0xf,
	},
};
...
static struct crl_sensor_detect_config imx290_sensor_detect_regset[] = {
	{
		.reg = { 0x332C, CRL_REG_LEN_08BIT, 0x000000ff },
		.width = 7,
	},	/*Default D1*/
	{
		.reg = { 0x332D, CRL_REG_LEN_08BIT, 0x000000ff },
		.width = 7,
	},	/*Default F0*/
};
...
static struct crl_subdev_rect_rep imx290_1948_1097_rects[] = {
	{
...
static struct crl_mode_rep imx290_modes[] = {
	{
		.sd_rects_items = ARRAY_SIZE(imx290_1948_1097_rects),
		.sd_rects = imx290_1948_1097_rects,
		.binn_hor = 1,
		.binn_vert = 3,
		.scale_m = 1,
		.width = 1948,
		...
		.comp_items = 0,
		.ctrl_data = 0,
		.mode_regs_items = ARRAY_SIZE(imx290_1948_1097_37MHZ_CROPPING),
		.mode_regs = imx290_1948_1097_37MHZ_CROPPING,
		},
	{
...
static struct crl_v4l2_ctrl imx290_v4l2_ctrls[] = {
	...
	},
	{
		...
		.impact = CRL_IMPACTS_NO_IMPACT,
		.ctrl = 0,
		.regs_items = ARRAY_SIZE(imx290_shs_regs),
		.regs = imx290_shs_regs,
		.dep_items = 0,
		.dep_ctrls = 0,
	},
	{
