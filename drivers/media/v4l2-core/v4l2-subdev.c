...
static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
{
	...
	case _IOC_NR(VIDIOC_SUBDEV_DV_TIMINGS_CAP): {
	...
	case _IOC_NR(VIDIOC_SUBDEV_ENUM_DV_TIMINGS): {
	...
	case _IOC_NR(VIDIOC_SUBDEV_QUERY_DV_TIMINGS):
		return v4l2_subdev_call(sd, video, query_dv_timings, arg);

	case _IOC_NR(VIDIOC_SUBDEV_G_DV_TIMINGS):
		return v4l2_subdev_call(sd, video, g_dv_timings, arg);

	case _IOC_NR(VIDIOC_SUBDEV_S_DV_TIMINGS):
