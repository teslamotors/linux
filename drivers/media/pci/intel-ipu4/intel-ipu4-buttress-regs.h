...
#define BUTTRESS_SENSOR_FREQ_CTL_OSC_OUT_FREQ_DEFAULT_B0(i)	(0x1b << ((i) * 10))
#define BUTTRESS_SENSOR_FREQ_CTL_OSC_OUT_FREQ_SHIFT_B0(i)	((i) * 10)
#define BUTTRESS_SENSOR_FREQ_CTL_OSC_OUT_FREQ_MASK_B0(i)	(0x1ff << ((i) * 10))
...
#define BUTTRESS_PS_FREQ_CAPABILITIES_EFFICIEMT_RATIO_MASK	(0xff << 8)
