...
/* Glv IPU5 A0 offsets */
#define INTEL_IPU5_GLV_A0_ISYS_IOMMU0_OFFSET		0x000e0000
#define INTEL_IPU5_GLV_A0_ISYS_IOMMU1_OFFSET		0x000e0100

#define INTEL_IPU5_GLV_A0_ISYS_OFFSET			0x00100000
#define INTEL_IPU5_GLV_A0_PSYS_OFFSET			0x00400000

#define INTEL_IPU5_GLV_A0_PSYS_IOMMU0_OFFSET		0x000b0000
#define INTEL_IPU5_GLV_A0_PSYS_IOMMU1_OFFSET		0x000b0100
#define INTEL_IPU5_GLV_A0_PSYS_IOMMU1R_OFFSET		0x000b0600

#define INTEL_IPU5_GLV_A0_TPG0_ADDR_OFFSET		0x69c00
#define INTEL_IPU5_GLV_A0_TPG1_ADDR_OFFSET		0x6bc00
#define INTEL_IPU5_GLV_A0_TPG2_ADDR_OFFSET		0x6dc00
#define INTEL_IPU5_GLV_A0_CSI2BE_ADDR_OFFSET		0xba000

/* Common for both A0 and B0 */
#define INTEL_IPU5_GLV_PSYS_MMU0_CTRL_OFFSET		0x08

#define INTEL_IPU5_GLV_GP0OFFSET			0x69800
#define INTEL_IPU5_GLV_GP1OFFSET			0x6B800
#define INTEL_IPU5_GLV_GP2OFFSET			0x6D800

#define INTEL_IPU5_DMEM_OFFSET				0x8000
...
#define INTEL_IPU5_ISYS_UNISPART_IRQ_CSI2_A0(bus)	(0x10 << (bus))

#define INTEL_IPU5_ISYS_UNISPART_IRQ_CSI2_B0(bus)		\
	((bus) < INTEL_IPU5_ISYS_MAX_CSI2_LEGACY_PORTS ?	\
	((0x8) << (bus)) :					\
	(0x800 << ((bus) - INTEL_IPU5_ISYS_MAX_CSI2_LEGACY_PORTS)))

#define INTEL_IPU5_ISYS_UNISPART_IRQ_SW			(1 << 30)
...
#define INTEL_IPU5_PSYS_REG_SPC_STATUS_CTRL			0x0
...
#define INTEL_IPU5_PSYS_REG_SPF_STATUS_CTRL		0x40000
#define INTEL_IPU5_PSYS_REG_ISP0_STATUS_CTRL		0x1C0000
#define INTEL_IPU5_PSYS_REG_ISP1_STATUS_CTRL		0x240000
#define INTEL_IPU5_PSYS_REG_ISP2_STATUS_CTRL		0x2C0000
#define INTEL_IPU5_PSYS_REG_ISP3_STATUS_CTRL		0x340000
...
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_EDGE		0x60200
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_MASK		0x60204
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_STATUS		0x60208
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_CLEAR		0x6020c
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_ENABLE		0x60210
#define INTEL_IPU5_REG_PSYS_GPDEV_IRQ_LEVEL_NOT_PULSE	0x60214
/* There are 8 FW interrupts, n = 0..7 */
#define INTEL_IPU5_PSYS_GPDEV_IRQ_FWIRQ(n)		(BIT(17) << (n))
#define INTEL_IPU5_REG_PSYS_GPDEV_FWIRQ(n)		(4 * (n) + 0x60100)
/* CDC Burst collector thresholds for psys - 4 FIFOs i= 0..3 */
#define INTEL_IPU5_REG_PSYS_CDC_THRESHOLD(i)           (0x60600 + ((i) * 4))
...
#define INTEL_IPU5_TRACE_REG_IS_ISL_GPC_BASE			0x0bd400
#define INTEL_IPU5_TRACE_REG_IS_MMU_GPC_BASE			0x0e0B00
/* CSI2 receivers */
#define INTEL_IPU5_TRACE_REG_CSI2_TM_BASE				0x067a00
#define INTEL_IPU5_TRACE_REG_CSI2_3PH_TM_BASE			0x06f200

/* Trace timers */
#define INTEL_IPU5_TRACE_REG_PS_GPREG_TRACE_TIMER_RST_N		0x060614
...
#define INTEL_IPU5_TRACE_REG_CSI2_SIG2SIO_GRn_BASE(n)		\
			(0x067c00 + (n) * 0x20)
#define INTEL_IPU5_TRACE_REG_CSI2_SIG2SIO_GR_NUM			9

/* 0 < n <= 8 */
#define INTEL_IPU5_TRACE_REG_CSI2_PH3_SIG2SIO_GRn_BASE(n)		\
			(0x06f600 + (n) * 0x20)
#define INTEL_IPU5_TRACE_REG_CSI2_PH3_SIG2SIO_GR_NUM		9

/* PSYS trace registers - offsets to isys base address */
/* Trace unit base offset */
#define INTEL_IPU5_TRACE_REG_PS_TRACE_UNIT_BASE			0x3e0000
/* Trace monitors */
#define INTEL_IPU5_TRACE_REG_PS_SPC_EVQ_BASE			0x001000
#define INTEL_IPU5_TRACE_REG_PS_SPP0_EVQ_BASE			0x021000
#define INTEL_IPU5_TRACE_REG_PS_SPP1_EVQ_BASE			0x031000
#define INTEL_IPU5_TRACE_REG_PS_SPF_EVQ_BASE			0x041000
#define INTEL_IPU5_TRACE_REG_PS_ISP0_EVQ_BASE			0x1c1000
#define INTEL_IPU5_TRACE_REG_PS_ISP1_EVQ_BASE			0x241000
#define INTEL_IPU5_TRACE_REG_PS_ISP2_EVQ_BASE			0x2c1000
#define INTEL_IPU5_TRACE_REG_PS_ISP3_EVQ_BASE			0x341000

/* GPC blocks */
#define INTEL_IPU5_TRACE_REG_PS_SPC_GPC_BASE			0x000800
#define INTEL_IPU5_TRACE_REG_PS_SPP0_GPC_BASE			0x020800
#define INTEL_IPU5_TRACE_REG_PS_SPP1_GPC_BASE			0x030800
#define INTEL_IPU5_TRACE_REG_PS_SPF_GPC_BASE			0x040800
#define INTEL_IPU5_TRACE_REG_PS_MMU_GPC_BASE			0x0b0b00
#define INTEL_IPU5_TRACE_REG_PS_ISL_GPC_BASE			0x0fe800
#define INTEL_IPU5_TRACE_REG_PS_ISP0_GPC_BASE			0x1c0800
#define INTEL_IPU5_TRACE_REG_PS_ISP1_GPC_BASE			0x240800
#define INTEL_IPU5_TRACE_REG_PS_ISP2_GPC_BASE			0x2c0800
#define INTEL_IPU5_TRACE_REG_PS_ISP3_GPC_BASE			0x340800
