...
struct ia_css_kernel_fragment_sequencer_info_desc_s {
	...
	uint16_t fragment_grid_point_decimation_factor[IA_CSS_N_DATA_DIMENSION];
	/* Relative position of grid origin to pixel origin */
	int16_t
fragment_grid_overlay_on_fragment_pixel_topleft_index[IA_CSS_N_DATA_DIMENSION];
	/* Size of active fragment region */
	int16_t
fragment_grid_overlay_on_fragment_pixel_dimension[IA_CSS_N_DATA_DIMENSION];
