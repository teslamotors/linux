...
ipu_device_sp2600_proxy_masters[IPU_DEVICE_SP2600_PROXY_NUM_MASTERS] = {
	{0, 0xC, IPU_DEVICE_SP2600_PROXY_ICACHE_BASE, IPU_DEVICE_SP2600_PROXY_ICACHE_INFO},
	{0, 0xC, IPU_DEVICE_SP2600_PROXY_QMEM_BASE,   0xFFFFFFFF},
	{2, 0xC, IPU_DEVICE_SP2600_PROXY_CMEM_BASE,   IPU_DEVICE_SP2600_PROXY_CMEM_INFO},
	{2, 0xC, IPU_DEVICE_SP2600_PROXY_XMEM_BASE,   IPU_DEVICE_SP2600_PROXY_XMEM_INFO}
};
...
static const struct ipu_device_cell_count_s ipu_device_sp2600_proxy_count = {
	...
	IPU_DEVICE_SP2600_PROXY_NUM_MASTERS,
	IPU_DEVICE_SP2600_PROXY_NUM_STALL_BITS,
	IPU_DEVICE_SP2600_PROXY_ICACHE_WORD_SIZE * IPU_DEVICE_SP2600_PROXY_ICACHE_BURST_SIZE
};

static const unsigned int ipu_device_sp2600_proxy_reg_offset[/* CELL_NUM_REGS */] = {
