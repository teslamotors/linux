...
/** Memory and device channel are represented as same kind of resource
 *  therefore the latter should be a continuation of the former
 */
typedef enum {
 ...
 */
#define VIED_NCI_VMEM0_SIZE	(0x0800)
#define VIED_NCI_VMEM1_SIZE	(0x0800)
#define VIED_NCI_VMEM2_SIZE	(0x0800)
#define VIED_NCI_VMEM3_SIZE	(0x0800)
#define VIED_NCI_VMEM4_SIZE	(0x0800)
#define VIED_NCI_BAMEM0_SIZE	(0x0400)
#define VIED_NCI_BAMEM1_SIZE	(0x0400)
#define VIED_NCI_BAMEM2_SIZE	(0x0400)
#define VIED_NCI_BAMEM3_SIZE	(0x0400)
#define VIED_NCI_DMEM0_SIZE	(0x1000)
#define VIED_NCI_DMEM1_SIZE	(0x1000)
#define VIED_NCI_DMEM2_SIZE	(0x1000)
#define VIED_NCI_DMEM3_SIZE	(0x1000)
#define VIED_NCI_DMEM4_SIZE	(0x1000)
#define VIED_NCI_DMEM5_SIZE	(0x1000)
#define VIED_NCI_DMEM6_SIZE	(0x1000)
#define VIED_NCI_DMEM7_SIZE	(0x1000)
#define VIED_NCI_PMEM0_SIZE	(0x0500)
#define VIED_NCI_PMEM1_SIZE	(0x0500)
#define VIED_NCI_PMEM2_SIZE	(0x0500)
#define VIED_NCI_PMEM3_SIZE	(0x0500)
...
/* resource spec for all resource */
