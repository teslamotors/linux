...
/*! Compute the size of storage required for allocating the program group manifest object
 ...
 @param	cached_in_param_section_count[in]		Number of parameter in terminal sections
 @param	cached_out_param_section_count[in]		Number of parameter out terminal sections
 @param	sliced_param_section_count[in]			Array[sliced_terminal_count] with sections per sliced in terminal
 @param	sliced_out_param_section_count[in]		Array[sliced_terminal_count] with sections per sliced out terminal
 ...
 @param	kernel_fragment_seq_count[in]			Number of kernel_fragment_seq_count.
