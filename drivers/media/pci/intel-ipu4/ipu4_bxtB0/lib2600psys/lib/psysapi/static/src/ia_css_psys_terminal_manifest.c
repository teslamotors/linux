	...
	const ia_css_terminal_manifest_t		*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_is_terminal_manifest_sliced_terminal(): enter:\n");
...
EXIT:
	if (NULL == manifest) {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, ERROR, "ia_css_data_terminal_manifest_set_min_size invalid argument\n");
	}
	return retval;
}
...
EXIT:
	if (NULL == manifest) {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, ERROR, "ia_css_data_terminal_manifest_set_max_size invalid argument\n");
	}
	return retval;
}
...
EXIT:
	if (NULL == manifest) {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, ERROR, "ia_css_data_terminal_manifest_get_min_size invalid argument\n");
	}
	return retval;
}
	...
	void									*fid)
{
	...
	if (terminal_type == IA_CSS_TERMINAL_TYPE_PARAM_CACHED_IN ||
		...
		for (i = 0; i < section_count; i++) {
		   ...
		   terminal_type == IA_CSS_TERMINAL_TYPE_PARAM_SLICED_OUT) {
		ia_css_sliced_param_terminal_manifest_t *sliced_terminal_manifest = (ia_css_sliced_param_terminal_manifest_t *)manifest;
		uint32_t kernel_id;
		uint16_t section_count;
		uint16_t section_idx;

		kernel_id = sliced_terminal_manifest->kernel_id;
		section_count = sliced_terminal_manifest->sliced_param_section_count;
		...
		sequencer_info_kernel_id = program_terminal_manifest->sequencer_info_kernel_id;
		max_kernel_fragment_sequencer_command_desc = program_terminal_manifest->max_kernel_fragment_sequencer_command_desc;
		kernel_fragment_sequencer_info_manifest_info_count = program_terminal_manifest->kernel_fragment_sequencer_info_manifest_info_count;
		...
		for (seq_info_idx = 0; seq_info_idx < kernel_fragment_sequencer_info_manifest_info_count; seq_info_idx++) {
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "max_fragment_grid_slice_dimension[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "min_fragment_grid_slice_count[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "max_fragment_grid_slice_count[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "min_fragment_grid_point_decimation_factor[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "max_fragment_grid_point_decimation_factor[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "min_fragment_grid_overlay_on_fragment_pixel_topleft_index[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "max_fragment_grid_overlay_on_fragment_pixel_topleft_index[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "min_fragment_grid_overlay_on_fragment_pixel_dimension[] = {%d, %d}\n",
			...
			IA_CSS_TRACE_2(PSYSAPI_STATIC, INFO, "max_fragment_grid_overlay_on_fragment_pixel_dimension[] = {%d, %d}\n",
