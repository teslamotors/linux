...
/*
	...
	- IA_CSS_PSYS_STATE_INITIALING = some of the psys components are not initialized yet
	- IA_CSS_PSYS_STATE_INITIALIZED = psys components are initialized
	- IA_CSS_PSYS_STATE_STARTING = some of the psys components are initialized but not started yet
	- IA_CSS_PSYS_STATE_STARTED = psys components are started
	- IA_CSS_PSYS_STATE_RUNNING = some of the psys components are started but not ready yet
...
typedef enum ia_css_psys_state {
	...
	IA_CSS_PSYS_STATE_STARTED = IA_CSS_PSYS_STATE_STARTED_PATTERN,			/**< psys components are started			*/
	IA_CSS_PSYS_STATE_RUNNING = IA_CSS_PSYS_STATE_RUNNING_PATTERN,			/**< some of the psys components are not ready yet	*/
