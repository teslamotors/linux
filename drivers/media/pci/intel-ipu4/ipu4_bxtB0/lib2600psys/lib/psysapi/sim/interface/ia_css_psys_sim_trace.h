 ...
 */
	...
	/* Module/sub-module specific trace setting */
		...
		#define PSYSAPI_SIM_TRACE_METHOD		IA_CSS_TRACE_METHOD_NATIVE
		#define PSYSAPI_SIM_TRACE_LEVEL_ASSERT		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_ERROR		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_INFO		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_DEBUG		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_DISABLED
	#elif PSYSAPI_SIM_TRACING_OVERRIDE == PSYSAPI_TRACE_LOG_LEVEL_NORMAL
		/* PSYSAPI_TRACE_LOG_LEVEL_NORMAL */
		#define PSYSAPI_SIM_TRACE_METHOD		IA_CSS_TRACE_METHOD_NATIVE
		#define PSYSAPI_SIM_TRACE_LEVEL_ASSERT		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_ERROR		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_INFO		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_DEBUG		IA_CSS_TRACE_LEVEL_DISABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_DISABLED
	#elif PSYSAPI_SIM_TRACING_OVERRIDE == PSYSAPI_TRACE_LOG_LEVEL_DEBUG
		/* PSYSAPI_TRACE_LOG_LEVEL_DEBUG */
		#define PSYSAPI_SIM_TRACE_METHOD		IA_CSS_TRACE_METHOD_NATIVE
		#define PSYSAPI_SIM_TRACE_LEVEL_ASSERT		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_ERROR		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_INFO		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_DEBUG		IA_CSS_TRACE_LEVEL_ENABLED
		#define PSYSAPI_SIM_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_ENABLED
	#else
