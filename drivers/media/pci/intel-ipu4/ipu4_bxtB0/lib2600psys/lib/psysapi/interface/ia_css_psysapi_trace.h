...
/* PSYSAPI and all the submodules in PSYSAPI will have the default tracing level set to the PSYSAPI_TRACE_CONFIG
   level. If not defined in the psysapi.mk fill it will be set by default to no trace (PSYSAPI_TRACE_LOG_LEVEL_OFF)
 */
