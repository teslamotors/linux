 ...
 */
const vied_nci_mem_type_ID_t vied_nci_cell_mem_type[VIED_NCI_N_CELL_TYPE_ID][VIED_NCI_N_MEM_TYPE_ID] = {
 ...
 */
const vied_nci_mem_ID_t vied_nci_cell_mem[VIED_NCI_N_CELL_ID][VIED_NCI_N_MEM_TYPE_ID] = {
...
const vied_nci_resource_spec_t vied_nci_psys_reserved_resources = {
	/* internal memory */
	{	/* resource id				size	offset */
		{VIED_NCI_N_MEM_TYPE_ID,		0,	0},
		{VIED_NCI_DMEM_TYPE_ID,			0,	0},
	...
	/* device channel */
	{	/* resource id				size	offset */
		{VIED_NCI_DEV_CHN_DMA_EXT0_ID,		0,	0},
