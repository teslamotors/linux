 ...
 * Log levels not in the range below will cause a "No BXT_SPCTRL_TRACE_CONFIG Tracing level defined"
 */
...
/* BXT_SPCTRL and all the submodules in BXT_SPCTRL will have the default tracing level set to the BXT_SPCTRL_TRACE_CONFIG
   level. If not defined in the psysapi.mk fill it will be set by default to no trace (BXT_SPCTRL_TRACE_LOG_LEVEL_NORMAL)
 */
...
/* BXT_SPCTRL Module tracing backend is mapped to TUNIT tracing for target platforms */
#ifdef __HIVECC
#	ifndef HRT_CSIM
...
#		define BXT_SPCTRL_TRACE_LEVEL_ASSERT	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_ERROR	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_INFO	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_DEBUG	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_DISABLED
#	elif BXT_SPCTRL_TRACE_CONFIG == BXT_SPCTRL_TRACE_LOG_LEVEL_NORMAL
		/* BXT_SPCTRL_TRACE_LOG_LEVEL_NORMAL */
#		define BXT_SPCTRL_TRACE_LEVEL_ASSERT	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_ERROR	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_INFO	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_DEBUG	IA_CSS_TRACE_LEVEL_DISABLED
#		define BXT_SPCTRL_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_DISABLED
#	elif BXT_SPCTRL_TRACE_CONFIG == BXT_SPCTRL_TRACE_LOG_LEVEL_DEBUG
		/* BXT_SPCTRL_TRACE_LOG_LEVEL_DEBUG */
#		define BXT_SPCTRL_TRACE_LEVEL_ASSERT	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_ERROR	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_WARNING	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_INFO	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_DEBUG	IA_CSS_TRACE_LEVEL_ENABLED
#		define BXT_SPCTRL_TRACE_LEVEL_VERBOSE	IA_CSS_TRACE_LEVEL_ENABLED
#	else
