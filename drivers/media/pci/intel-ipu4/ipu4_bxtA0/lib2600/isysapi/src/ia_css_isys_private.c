...
static const struct frame_format_info ft_info_per_frame_format_type[N_IA_CSS_ISYS_FRAME_FORMAT] = {
	/* bits_per_raw_pixel*/			/* plane_count */	/* plane_horz_divider */	/* plane_vert_divider */
	{8,					2,			{1,2,0,0},			{1,1,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV11,          	12 bit YUV 411, Y, UV plane */
	{8,					2,			{1,1,0,0},			{1,2,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV12,          	12 bit YUV 420, Y, UV plane */
	{IA_CSS_UNSUPPORTED_FRAME_FORMAT_TYPE,	0,			{0,0,0,0},			{0,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV12_16,       	16 bit YUV 420, Y, UV plane */
	{IA_CSS_UNSUPPORTED_FRAME_FORMAT_TYPE,	0,			{0,0,0,0},			{0,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV12_TILEY,    	12 bit YUV 420, Intel proprietary tiled format, TileY */
	{8,					2,			{1,1,0,0},			{1,1,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV16,          	16 bit YUV 422, Y, UV plane */
	{8,					2,			{1,1,0,0},			{1,2,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV21,          	12 bit YUV 420, Y, VU plane */
	{8,					2,			{1,1,0,0},			{1,1,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_NV61,          	16 bit YUV 422, Y, VU plane */
	{8,					3,			{1,2,2,0},			{1,2,2,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YV12,          	12 bit YUV 420, Y, V, U plane */
	{8,					3,			{1,2,2,0},			{1,1,1,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YV16,          	16 bit YUV 422, Y, V, U plane */
	{8,					3,			{1,2,2,0},			{1,2,2,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV420,        	12 bit YUV 420, Y, U, V plane */
	{24,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV420_16,     	yuv420, 16 bits per subpixel, single plane */
	{8,					3,			{1,2,2,0},			{1,1,1,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV422,        	12 bit YUV 422, Y, U, V plane */
	{32,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV422_16,     	yuv422, 16 bits per subpixel, single plane */
	{16,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_UYVY,          	16 bit YUV 422, UYVY interleaved */
	{16,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUYV,          	16 bit YUV 422, YUYV interleaved */
	{8,					3,			{1,1,1,0},			{1,1,1,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV444,        	24 bit YUV 444, Y, U, V plane */
	{IA_CSS_UNSUPPORTED_FRAME_FORMAT_TYPE,	0,			{0,0,0,0},			{0,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_YUV_LINE,      	Internal 422 format, 2 y lines followed by a uv interleaved line */
	{8,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RAW8,	        	RAW8, 1 plane */
	{10,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RAW10,	        	RAW10, 1 plane */
	{12,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RAW12,	        	RAW12, 1 plane */
	{14,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RAW14,	        	RAW14, 1 plane */
	{16,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RAW16,	        	RAW16, 1 plane */
	{16,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RGB565,		16 bit RGB, 1 plane. Each 3 sub
																								pixels are packed into one 16 bit value, 5 bits for R, 6 bits
																								for G and 5 bits for B. */
	{8,					3,			{1,1,1,0},			{1,1,1,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_PLANAR_RGB888,		24 bit RGB, 3 planes */
	{32,					1,			{1,0,0,0},			{1,0,0,0}	},	/*		IA_CSS_ISYS_FRAME_FORMAT_RGBA888,		32 bit RGBA, 1 plane, A=Alpha (alpha is unused) */
	{IA_CSS_UNSUPPORTED_FRAME_FORMAT_TYPE,	0,			{0,0,0,0},			{0,0,0,0}	},	/*	IA_CSS_ISYS_FRAME_FORMAT_QPLANE6,		Internal, for advanced ISP, not used */
	{8,					1,			{1,0,0,0},			{1,0,0,0}	}	/*		IA_CSS_ISYS_FRAME_FORMAT_BINARY_8,		byte stream, used for jpeg. */
};
...
STORAGE_CLASS_INLINE void buffer_partition_host_to_css(const struct ia_css_isys_buffer_partition *buffer_partition_host, struct ia_css_isys_buffer_partition_comm *buffer_partition_css) {
	unsigned int i;
	buffer_partition_css->nof_blocks = buffer_partition_host->nof_blocks;
	if (buffer_partition_host->nof_blocks > 0) {
		buffer_partition_css->block_limit[0] = buffer_partition_host->block_size[0];
		for (i = 1; i < buffer_partition_host->nof_blocks; i++) {
			buffer_partition_css->block_limit[i] = buffer_partition_css->block_limit[i-1] + buffer_partition_host->block_size[i];
		}
		for (i = buffer_partition_host->nof_blocks; i < NOF_SRAM_BLOCKS_MAX; i++) {
			buffer_partition_css->block_limit[i] = 0;
		}
	}
}
...
STORAGE_CLASS_INLINE void frame_buff_set_host_to_css(const struct ia_css_isys_frame_buff_set *frame_buff_set_host, struct ia_css_isys_frame_buff_set_comm *frame_buff_set_css) {
	...
	}
	{
		...
		param_pin_host_to_css(&frame_buff_set_host->blc_param, &frame_buff_set_css->blc_param);
		param_pin_host_to_css(&frame_buff_set_host->lsc_param, &frame_buff_set_css->lsc_param);
		param_pin_host_to_css(&frame_buff_set_host->dpc_param, &frame_buff_set_css->dpc_param);
		param_pin_host_to_css(&frame_buff_set_host->ids_param, &frame_buff_set_css->ids_param);
		param_pin_host_to_css(&frame_buff_set_host->awb_param, &frame_buff_set_css->awb_param);
		param_pin_host_to_css(&frame_buff_set_host->ae_param, &frame_buff_set_css->ae_param);
		param_pin_host_to_css(&frame_buff_set_host->af_param, &frame_buff_set_css->af_param);
