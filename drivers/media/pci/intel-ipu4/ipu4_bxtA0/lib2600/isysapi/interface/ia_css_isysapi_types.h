...
struct ia_css_isys_frame_buff_set {
	struct ia_css_isys_output_pin_payload output_pins[MAX_OPINS];
	struct ia_css_isys_param_pin blc_param;
	struct ia_css_isys_param_pin lsc_param;
	struct ia_css_isys_param_pin dpc_param;
	struct ia_css_isys_param_pin ids_param;
	struct ia_css_isys_param_pin awb_param;
	struct ia_css_isys_param_pin af_param;
	struct ia_css_isys_param_pin ae_param;
	unsigned int send_irq_sof;
	unsigned int send_irq_eof;
};
