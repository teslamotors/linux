	...
	const uint8_t							terminal_dependency_count)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_sizeof_program_manifest(): enter:\n");
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_has_program_manifest_fixed_cell(): enter:\n");
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_size(): enter:\n");

	if (manifest != NULL) {
		size = manifest->size;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_size invalid argument\n");
	}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	if (manifest != NULL) {
		...
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_program_ID invalid argument\n");
	}
	return program_id;
}
	...
	ia_css_program_ID_t id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_program_ID(): enter:\n");

	if (manifest != NULL) {
		manifest->ID = id;
		ret = 0;
	} else {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_program_ID failed (%i)\n", ret);
	}
	return ret;
}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_parent(): enter:\n");
	...
	int32_t program_offset)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_parent_offset(): enter:\n");
...
EXIT:
	if (retval != 0) {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_parent_offset failed (%i)\n", retval);
	}
	return retval;
}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_type(): enter:\n");

	if (manifest != NULL) {
		program_type = manifest->program_type;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_type invalid argument\n");
	}
	return program_type;
}
	...
	const ia_css_program_type_t				program_type)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_type(): enter:\n");

	if (manifest != NULL) {
		manifest->program_type = program_type;
		retval = 0;
	} else {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_type failed (%i)\n", retval);
	}
	return retval;
}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_kernel_bitmap(): enter:\n");

	if (manifest != NULL) {
		kernel_bitmap = manifest->kernel_bitmap;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_kernel_bitmap invalid argument\n");
	}
	...
	const ia_css_kernel_bitmap_t			kernel_bitmap)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_kernel_bitmap(): enter:\n");

	if (manifest != NULL) {
		manifest->kernel_bitmap = kernel_bitmap;
		retval = 0;
	} else {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_kernel_bitmap failed (%i)\n", retval);
	}
	return retval;
}
#endif
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_cell_ID(): enter:\n");
	...
	const vied_nci_cell_ID_t			cell_id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_cell_ID(): enter:\n");
	if (manifest != NULL) {
		manifest->cell_id = cell_id;
		retval = 0;
	} else {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_cell_ID failed (%i)\n", retval);
	}
	return retval;
}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_cell_type_ID(): enter:\n");
	...
	const vied_nci_cell_type_ID_t		cell_type_id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_cell_type_ID(): enter:\n");
	if (manifest != NULL) {
		manifest->cell_type_id = cell_type_id;
		retval = 0;
	} else {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_cell_type_ID failed (%i)\n", retval);
	}
	return retval;
}
	...
	const vied_nci_mem_type_ID_t			mem_type_id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_int_mem_size(): enter:\n");
	...
	/* loop over vied_nci_cell_mem_type to verify mem_type_id for a specific cell_type_id */
	...
	const vied_nci_resource_size_t			int_mem_size)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_int_mem_size(): enter:\n");
	...
	const vied_nci_mem_type_ID_t			mem_type_id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_ext_mem_size(): enter:\n");
	...
	const vied_nci_resource_size_t			ext_mem_size)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_ext_mem_size(): enter:\n");

	if (manifest != NULL && mem_type_id < VIED_NCI_N_DATA_MEM_TYPE_ID) {
		manifest->ext_mem_size[mem_type_id] = ext_mem_size;
		retval = 0;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_set_ext_mem_size invalid argument\n");
	}
	...
	const vied_nci_dev_chn_ID_t				dev_chn_id)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_dev_chn_size(): enter:\n");
	...
	const vied_nci_resource_size_t			dev_chn_size)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_dev_chn_size(): enter:\n");

	if (manifest != NULL && dev_chn_id < VIED_NCI_N_DEV_CHN_ID) {
		manifest->dev_chn_size[dev_chn_id] = dev_chn_size;
		retval = 0;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_set_dev_chn_size invalid argument\n");
	}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_get_program_dependency_count(): enter:\n");

	if (manifest != NULL) {
		program_dependency_count = manifest->program_dependency_count;
	} else {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_program_dependency_count invalid argument\n");
	}
	...
	const unsigned int		index)
{
	...
	if (index < program_dependency_count) {
		...
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_program_dependency invalid argument\n");
	}
	...
	const unsigned int						index)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_program_manifest_set_program_dependency(): enter:\n");
	...
	if (retval != 0) {
		IA_CSS_TRACE_3(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_program_dependency(m, %d, %d) failed (%i)\n",
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	if (manifest != NULL) {
		...
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING, "ia_css_program_manifest_get_terminal_dependency_count invalid argument\n");
	}
	...
	const unsigned int						index)
{
	...
	if (retval != 0) {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_set_terminal_dependency failed (%i)\n", retval);
	}
	return retval;
}
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_is_program_manifest_subnode_program_type(): enter:\n");
	...
	const ia_css_program_manifest_t			*manifest)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, VERBOSE, "ia_css_is_program_manifest_supernode_program_type(): enter:\n");
	...
	const uint8_t	terminal_dependency_count)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, INFO, "ia_css_program_manifest_init(): enter:\n");
	...
	blob->size = (uint16_t)ia_css_sizeof_program_manifest(program_dependency_count,
	...
	void									*fid)
{
	...
	IA_CSS_TRACE_0(PSYSAPI_STATIC, INFO, "ia_css_program_manifest_print(): enter:\n");
...
EXIT:
	if (retval != 0) {
		IA_CSS_TRACE_1(PSYSAPI_STATIC, ERROR, "ia_css_program_manifest_print failed (%i)\n", retval);
	}
	return retval;
}
#endif
