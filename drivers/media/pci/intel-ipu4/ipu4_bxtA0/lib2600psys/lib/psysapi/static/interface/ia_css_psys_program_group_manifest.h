...
/*!	initialize program group manifest
 ...
 @param	terminal_type[in]			array of terminal types, binary specific
						static frame data
 @param	param_section_count[in]			Number of parameter terminal sections
 @param param_out_section_count[in]		Number of parameter terminal out sections
 @param	spatial_param_section_count[in]		Array[spatial_terminal_count] with sections per spatial terminal
