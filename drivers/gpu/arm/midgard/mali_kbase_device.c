...
int kbase_device_init(struct kbase_device * const kbdev)
{
	...
	/* map gpu noc port registers */
	kbdev->regnoc[0] = ioremap(GPU_M0_PORT, 4);
	kbdev->regnoc[1] = ioremap(GPU_M1_PORT, 4);
	kbdev->regnoc[2] = ioremap(GPU_M2_PORT, 4);
	kbdev->regnoc[3] = ioremap(GPU_M3_PORT, 4);

	kbdev->regack[0] = ioremap(GPU_M0_ACK, 4);
	kbdev->regack[1] = ioremap(GPU_M1_ACK, 4);
	kbdev->regack[2] = ioremap(GPU_M2_ACK, 4);
	kbdev->regack[3] = ioremap(GPU_M3_ACK, 4);
