...
#define CRL_CID_EXPOSURE_SHS1		(V4L2_CID_CRLMODULE_BASE + 9)
#define CRL_CID_EXPOSURE_SHS2		(V4L2_CID_CRLMODULE_BASE + 10)
#define CRL_CID_EXPOSURE_SHS3		(V4L2_CID_CRLMODULE_BASE + 11)
#define CRL_CID_EXPOSURE_RHS1		(V4L2_CID_CRLMODULE_BASE + 12)
#define CRL_CID_EXPOSURE_RHS2		(V4L2_CID_CRLMODULE_BASE + 13)
