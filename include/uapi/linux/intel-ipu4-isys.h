...
#define VIDIOC_INTEL_IPU_SET_LINK_ID\
	_IOWR('v', BASE_VIDIOC_PRIVATE + 1, uint8_t)

#define VIDIOC_INTEL_IPU_SET_FRAME_COUNTER\
	_IOWR('v', BASE_VIDIOC_PRIVATE + 2, struct intel_ipu_frame_counter)
