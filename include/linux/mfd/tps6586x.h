...
#define RTC_CL_SEL_MASK (3 << 1)	/* external crystal capacitance load select */
#define RTC_CL_SEL_1P5  (0x00 << 1)	/* 1.5 pF */
#define RTC_CL_SEL_6P5  (0x01 << 1)	/* 6.5 pF */
#define RTC_CL_SEL_7P5  (0x02 << 1)	/* 7.5 pF */
#define RTC_CL_SEL_12P5 (0x03 << 1)	/* 12.5 pF */

struct tps6586x_rtc_platform_data {
	int irq;
	int xtal_load_capacitance;	/* set capacitance value for crystal load if allowed */
};
