...
#define MMC_SLOW_WRITE_TIME	500000
#define MMC_REFRESH_INTERVAL	60
#define MMC_BKOPS_INTERVAL	20
...
extern int mmc_gen_cmd_args(struct mmc_card *card, void *buf, u8 index, u8 arg1,
			    u8 arg2, u8 mode);
