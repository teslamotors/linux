/* compat26/include/mach/irqs.h
 *
 * Copyright 2016 Codethink Ltd.
 *	Ben Dooks <ben.dooks@codethink.co.uk>
 *
 * Add IRQs needed by bits of the code (may require remap in registration)
*/

#ifndef __MACH_IRQS_H
#define __MACH_IRQS_H

/* We only need this for Tegra2, Tegra3 don't need anything here,
 * the panel code doesn't use it and nothing else has failed to
 * build without it being there
 */
...
#if defined(CONFIG_ARCH_TEGRA_2x_SOC) && 0
...
#define INT_DISPLAY_GENERAL		(-1024)
