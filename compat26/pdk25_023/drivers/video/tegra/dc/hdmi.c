...
static inline void tegra_dc_hdmi_debug_remove(struct tegra_dc_hdmi_data *hdmi)
{
	if (hdmidir) {
		debugfs_remove_recursive(hdmidir);
		hdmidir = NULL;
...
static void tegra_dc_hdmi_destroy(struct tegra_dc *dc)
{
	...
	tegra_dc_hdmi_debug_remove(hdmi);
...
struct tegra_edid *tegra_dc_get_edid_struct(struct tegra_dc *dc)
{
	struct tegra_dc_hdmi_data *hdmi;
