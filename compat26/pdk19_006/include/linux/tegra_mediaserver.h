...
#define TEGRA_MEDIASERVER_IOCTL_GET_HWA_AUDIODEC_COUNT	\
	_IOR(TEGRA_MEDIASERVER_MAGIC, 0x50, unsigned int)


#define TEGRA_MEDIASERVER_IOCTL_SET_HWA_AUDIODEC_COUNT	\
	_IOR(TEGRA_MEDIASERVER_MAGIC, 0x51, unsigned int)
